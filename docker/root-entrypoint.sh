...
WHEEL_CACHE_DIR="${WHEEL_CACHE_DIR:-/app/smart-contract/wheel-cache}"
...
WHEEL_CACHE_MAX_BYTES="${WHEEL_CACHE_MAX_BYTES}" \
WHEEL_CACHE_MAX_FILE_BYTES="${WHEEL_CACHE_MAX_FILE_BYTES}" \
