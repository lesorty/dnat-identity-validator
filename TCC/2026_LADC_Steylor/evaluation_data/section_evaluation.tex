...
without launching a microVM---and the boot-time, AWS-cost, and blockchain-gas
measurements complete the comparative matrix in the follow-up campaign; the
corresponding cells in Table~\ref{tab:comparison} are marked \emph{TBD}.
...
single namespace of Environment~A.
...
Separating the planes (B vs A) adds nothing on top of this microVM cost. The
remaining \emph{TBD} row of Table~\ref{tab:comparison}, the blockchain gas of
registration and access purchase, is filled by the follow-up campaign.
