...
the containment and persistence properties demonstrated above. Build-plane cost
(latency with and without dependencies and artifact size) and the build-time
supply-chain test (T2) require the builder image and are documented as a
reproducible manual protocol in the artifact repository.
